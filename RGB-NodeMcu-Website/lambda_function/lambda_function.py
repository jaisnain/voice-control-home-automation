...
config = { 
         'host': 'a3gqm9sszde7zz-ats.iot.ap-south-1.amazonaws.com',
         'rootCAName': 'AmazonRootCA1.pem',
         'certificateName': '3c67c0f829-certificate.pem.crt',
         'privateKeyName' : '3c67c0f829-private.pem.key',
         'clientId': 'led_alexa',
         'port' : 8883
}

thing_name = "TwLedThing"
